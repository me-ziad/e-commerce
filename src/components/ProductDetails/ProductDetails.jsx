...
<Loader></Loader>
        ...
        <h1 className={`${style.styleHeader} mt-20 text-2xl mb-5 ps-4 dark:text-gray-400`}>Related Product:</h1>
      <div className=" flex  flex-wrap gap-y-4 ">
        
          {relatedProductCategory.map((product)=> <div key={product.id} className="m-auto lg:ms-auto   p-2  md:w-1/2  lg:w-1/5">
