  ...
  return<>
      ...
      {cart.data?.products.map((item, indix)=><tr key={indix} className="bg-white dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-600 border-b dark:text-gray-400 border-gray-200 hover:bg-gray-50 ">
            ...
            {item.price * item.count}
              ...
              <td className="px-6 py-1">
                <button onClick={()=>deleteCart(item.product.id)} className="font-medium text-red-600 dark:text-red-500 hover:underline">Remove</button>
              </td>
            </tr>
        )}
          </tbody>
            ...
            <div className=" mt-4">
            <h1  className=' uppercase  font-bold text-2xl text-cyan-800'>total price <span className='ms-4 text-[#FF9119]'>{cart.data?.totalCartPrice} EGY</span ></h1>
            </div>
            <div className=" mt-5 flex-col flex-wrap lg:flex-row flex">
