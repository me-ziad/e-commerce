...
export default function Cart() {
  ...
  return (
    <>
      <h1 className='text-gray-500 dark:text-gray-400 text-xl lg:text-xl px-10 font-semibold mb-4'>My Cart:</h1>
      {cart ? <>
        {cart.data?.products.length === 0 ? <>
          ...
          <div className="relative overflow-x-auto shadow-md sm:rounded-lg">
            ...
            <div className="w-full flex justify-center mt-5">
              ...
              <button onClick={() => clearCart()} className=' text-center hover:bg-red-600 pt-2 pb-2 ps-4 pe-4 bg-red-500 mb-4 text-white mt-6 rounded'>Remove Cart</button>
            </div>
          </div>
        )}
      </> :
