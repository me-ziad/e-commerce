...
<div className="flex flex-wrap justify-center items-center mb-10 rounded-xl overflow-hidden">
    ...
    <Slider {...settings}>
        <img src={slid1} className= ' w-full sm:h-[250px]  md:h-[450px] lg:h-[460px] object-center' alt="" />
        <img src={slid2} className='  w-full sm:h-[250px]  md:h-[450px] lg:h-[460px] object-center' alt="" />
